	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="person">
					<img src="<?php _e(TEMPLATE_URL) ?>/images/sample/team-1.jpg" alt="" class="img-responsive">
			...
			<div class="col-md-3 col-sm-6">
				<div class="person">
					<img src="<?php _e(TEMPLATE_URL) ?>/images/sample/team-2.jpg" alt="" class="img-responsive">
					<div class="person-content">
						<h4>Timothy Reed</h4>
			...
			<div class="col-md-3 col-sm-6">
				<div class="person">
					<img src="<?php _e(TEMPLATE_URL) ?>/images/sample/team-3.jpg" alt="" class="img-responsive">
					<div class="person-content">
			...
			<div class="col-md-3 col-sm-6">
				<div class="person">
					<img src="<?php _e(TEMPLATE_URL) ?>/images/sample/team-4.jpg" alt="" class="img-responsive">
					<div class="person-content">
