			...
			<div class="flexslider">
				<ul class="slides">
					<li>
						<div class="col-md-6">
							<div class="avatar">
								<img src="<?php _e(TEMPLATE_URL) ?>/images/sample/testimonial-1.jpg" alt="" class="img-responsive">
							</div>
						</div>
						<div class="col-md-6">
							<blockquote>
					...
					<li>
						<div class="col-md-6">
							<div class="avatar">
								<img src="<?php _e(TEMPLATE_URL) ?>/images/sample/testimonial-2.jpg" alt="" class="img-responsive">
							</div>
						</div>
						<div class="col-md-6">
							<blockquote>
